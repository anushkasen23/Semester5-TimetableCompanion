...
// Download AppGini for free from https://bigprof.com/appgini/download/
	...
	$x->QueryFieldsTV = array(   
		...
		"IF(    CHAR_LENGTH(`schools1`.`name`), CONCAT_WS('',   `schools1`.`name`), '') /* School */" => "Branch",
	...
	$x->filterers = array(  'Branch' => 'Branch', 'department' => 'Department');
	...
	$x->ColCaption = array("Date", "Time Start", "Time End", "Unit code", "Venue", "Branch", "Department", "Year of study");
	$x->ColFieldName = array('date', 'time_start', 'time_end', 'unit_code', 'venue', 'Branch', 'department', 'year_of_study');
